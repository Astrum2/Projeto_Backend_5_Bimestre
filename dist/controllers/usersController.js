...
const barbersController_1 = __importDefault(require("./barbersController"));
class UsersController {
    ...
    static async isStrongPassword(value, res) {
    ...
    static async isValidEmail(value, res) {
    ...
    static async isValidCpf(value, res) {
    ...
    static async create(req, res) {
        ...
        const savedUser = await User_1.default.findOne({
        ...
        if (isAdmin) {
            await barbersController_1.default.createFromData({
                name: user.name,
                user_id: user.id,
    ...
    static async update(req, res) {
        ...
        if (password !== undefined) {
            ...
            nextPassword = await bcrypt_1.default.hash(password.trim(), 10);
        }
        if (cpf !== undefined) {
            const cpfValidation = await UsersController.isValidCpf(cpf, res);
            if (cpfValidation) {
